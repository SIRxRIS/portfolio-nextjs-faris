...
// Dynamic import untuk DotLottie
...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 relative z-20 mb-3 sm:mb-4">
    <div className="relative group">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#6366f1] to-[#a855f7] rounded-full blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10 shadow-sm">
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-[6%] sm:px-8 lg:px-[10%] pt-8 sm:pt-12 lg:pt-16 min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between min-h-[calc(100vh-6rem)] gap-6 sm:gap-8 lg:gap-16">
            {/* Left Column */}
            ...
            <div
              className="w-full py-4 sm:py-0 lg:w-1/2 h-auto lg:h-[500px] xl:h-[600px] relative flex items-center justify-center order-2 lg:order-2"
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                >
                  {mounted && <DotLottieReact {...lottieOptions} />}
                </div>
